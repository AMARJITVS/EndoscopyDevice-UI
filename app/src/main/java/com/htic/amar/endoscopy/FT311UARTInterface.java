...
public class FT311UARTInterface extends Activity
{
	...
	public UsbAccessory[] accessories;
	...
	public int ResumeAccessory()
	{
		...
		if (accessory != null) {
			...
			if (usbmanager.hasPermission(accessory)) {
                ...
                Toast.makeText(global_context, "HAS USB Permission", Toast.LENGTH_SHORT).show();
			}
			else
			{
	...
	private final BroadcastReceiver mUsbReceiver = new BroadcastReceiver()
	{
		...
		public void onReceive(Context context, Intent intent)
		{
			...
			{
                Toast.makeText(global_context, "USB DETACHED", Toast.LENGTH_SHORT).show();
